...
function MapNavbar({ data, isLoading }: { data: DatafeedRouteResponse | null, isLoading: boolean }) {
    const router = useRouter();

    return <div className="fixed top-0 left-0 p-2 w-screen flex justify-center z-10">
